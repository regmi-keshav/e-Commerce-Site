...
//         <h1 className="text-4xl pt-2 font-bold tracking-tight text-gray-900">
//           Name : {user.name ? user.name : "New User"}
//         </h1>
//         <h3 className="text-xl pt-2 font-bold tracking-tight text-red-600">
//           email address : {user.email}
//         </h3>
//         <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
//           <button
//             type="submit"
//             className="rounded-md my-2 bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
//           >
//             Add New Address
//           </button>
//           {showAddAddressForm ? (
...
//                   <button
//                     onClick={(e) => handleEditFrom(index)}
//                     type="submit"
